...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function getAccountDetail(): ?AccountDetail
    {
        return $this->accountDetail;
    }

    public function setAccountDetail(AccountDetail $accountDetail): self
    {
        // set the owning side of the relation if necessary
        if ($accountDetail->getUser() !== $this) {
            $accountDetail->setUser($this);
        }
